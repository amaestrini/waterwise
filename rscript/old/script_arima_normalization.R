...
rzoo_code <- function(
  ...
  ###
    ...
    x <- normalizeGaussian(x=deltaclimate) ##ecdf(deltaclimate)(deltaclimate)*() %>% qnorm()
    xreg <- normalizeGaussian(x=climate_model_value,data=climate_model_value_all) #### ecdf(climate_model_value_all)(climate_model_value) %>% qnorm()
    newxreg <- normalizeGaussian(x=climate_model_value_all,data=climate_model_value_all) ####ecdf(climate_model_value_all)(climate_model_value_all) %>% qnorm()
  ###
